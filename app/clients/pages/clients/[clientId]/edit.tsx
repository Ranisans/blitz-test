...
export const EditClient = () => {
  ...
  const [client, { setQueryData }] = useQuery(getClient, { where: { id: clientId } });
      ...
      <ClientForm
        ...
        onSubmit={async () => {
          try {
            ...
            console.log(error);
            alert(`Error editing client ${JSON.stringify(error, null, 2)}`);
          }
        }}
      />
    </div>
...
EditClientPage.getLayout = (page) => <Layout title="Edit Client">{page}</Layout>;
